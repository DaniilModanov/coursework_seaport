package com.seaport.ServiceTwo.common;
...
import static com.seaport.ServiceTwo.common.Utilities.intToDateFormat;
...
public class Ship implements Comparable<Ship> {
    ...
    public Ship(String nameOfShip, TypeOfCargo typeOfCargo, int weight, Calendar timeOfArrival,
                Calendar scheduledTimeOfArrival, int timeOfUnload, int delayOfUnload) {
